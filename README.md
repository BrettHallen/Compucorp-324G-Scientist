...
- V<sub>SS</sub>: input voltage from AC charger or batteries, this is the system's reference voltage
- V<sub>BB</sub>: V<sub>SS</sub>+3V RAM chip bias voltage
- V<sub>DD</sub>: V<sub>SS</sub>-7.5V
- V<sub>GG</sub>: V<sub>SS</sub>-15V
- GND: V<sub>SS</sub>-5V
- V<sub>BIAS</sub>: -60V
- V<sub>KK</sub>: -120V
